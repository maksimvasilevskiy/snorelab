...
export const HowWorksBottom = () => {
  ...
  useEffect(() => {
    const storageKey = 'how Snorelab works';
        ...
        <div className="how-works__intro-wrapper">
          <div className="container">
            ...
            <div className="how-works__intro-text">
              ...
              <p>
                There are lots of other features and tools in&nbsp;the app. You
                can find out more about these and how to interpret your results
                in our{' '}
