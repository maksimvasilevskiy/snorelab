...
export const PartnerApp = ({ cards }) => {
  ...
  return (
    <section className="home-partner">
      <div className="home-partner__wrapper">
        <div className="container">
          <div className="home-partner__info">
            <h2 className="title title_size-m home-partner__info-title">
              Try our partner app
            </h2>
            <div className="home-partner__app">
              <div className="home-partner__app-icon">
                <svg
                  width="90"
                  height="90"
                  viewBox="0 0 90 90"
                ...
                >
                  <path
                    d="M90 0H0V90H90V0Z"
                    fill="url(#paint0_linear_125_1033)"
                  />
                  <path
                    d="M72.94 41.2483C70.8889 36.3247 67.5217 32.0471 63.2 28.8748C59.975 26.5535 49.035 20.2678 47.425 27.39C46.605 31.008 48.115 34.6705 49.965 37.6996C51 39.422 52 41.372 51.5 43.4755C50.545 47.2371 46.29 49.1426 42.715 47.93C39.86 46.9748 37.855 43.8962 38.525 40.9513C38.93 39.1597 40.12 37.7491 40.985 36.1702C42.425 33.5322 43.785 28.9193 42.13 26.0734C38.845 20.4064 28.24 27.5929 25.13 30.1814C21.2837 33.4387 18.3552 37.6266 16.63 42.3372C14.815 47.1529 13.69 52.6567 16.31 57.3883C16.42 57.5639 16.5938 57.6911 16.7957 57.7436C16.9975 57.7961 17.212 57.7699 17.395 57.6704C22.085 55.5372 27.15 53.899 32.355 54.9136C35.2958 55.5422 38.0706 56.7748 40.5 58.5316C41.845 59.472 43.255 60.5955 45 60.6104C46.745 60.6252 48.15 59.472 49.5 58.5316C51.8314 56.8471 54.4803 55.6421 57.29 54.9879C62.61 53.8247 67.79 55.4828 72.615 57.6655C72.7977 57.7662 73.0126 57.793 73.2148 57.7404C73.417 57.6879 73.5909 57.5599 73.7 57.3834C76.5 52.3102 75.025 46.3165 72.94 41.2483Z"
                    fill="url(#paint1_linear_125_1033)"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_125_1033"
                      x1="45"
                      y1="0"
                      x2="45"
                      y2="90"
                    ...
                    >
                      <stop stopColor="#012128" />
                      <stop offset="1" stopColor="#00323C" />
                    </linearGradient>
                    <linearGradient
                      id="paint1_linear_125_1033"
                      x1="45.005"
                      y1="59.5116"
                      x2="45.005"
                      y2="20.7726"
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop stopColor="#01BBE0" />
                      <stop offset="1" stopColor="#6ECDE0" />
                    </linearGradient>
                  </defs>
                </svg>
              </div>
              <span className="title title_fade title_size-l home-partner__app-title">
                SnoreGym
              </span>
            </div>
            <div className="home-partner__info-note">
              <p>Reduce your snoring with exercises for quiet sleep.</p>
            </div>
          </div>
          <div className="row">
            <div className="order-lg-1 col-12 col-lg-6">
              <div className="home-partner__phones">
                <div className="home-partner__phones-top">
                  ...
                  >
                    <path
                      d="M462.5 0L571.502 335.472H924.238L638.868 542.805L747.87 878.278L462.5 670.945L177.13 878.278L286.132 542.805L0.762054 335.472H353.498L462.5 0Z"
                      fill="#17A2FF"
                    />
                  </svg>*/}
                </div>
            ...
            <div className="order-lg-0 col-12 col-lg-6">
              <ul className="description__list">
                {cards.map((card) => (
                  <li
                    className="description__item home-partner__item"
                    key={card.partner_description_card_icon.id}
                  >
                    <div className="description__item-wrapper">
                      <div className="description__item-icon">
                        <img
                          src={card.partner_description_card_icon.url}
                          alt="description icon"
                        />
                      </div>
                      <div className="description__item-text">
                        <h4 className="title title_card description__item-title">
                          {card.partner_description_card_title}
                        </h4>
                        <p>{card.partner_description_card_text}</p>
                      </div>
                    </div>
                  </li>
                ))}
        ...
        >
          <path
            d="M-65.5 0L43.5015 335.472H396.238L110.868 542.805L219.87 878.278L-65.5 670.945L-350.87 878.278L-241.868 542.805L-527.238 335.472H-174.502L-65.5 0Z"
            fill="#17A2FF"
          />
        </svg>*/}
      </div>
